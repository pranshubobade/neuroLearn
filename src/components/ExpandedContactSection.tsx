...
import { Send, Mail, MapPin, Phone, Building, Handshake } from "lucide-react";
            ...
            >
              ...
              <div className="bg-background rounded-2xl p-6 border border-border">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-base font-semibold font-heading">Partnership Requests</h3>
                </div>
                <p className="text-sm text-muted-foreground mb-3">
                  Interested in partnering with NeuroLearn? Reach out at partnerships@neurolearn.ai
                </p>
              </div>
              ...
              <div className="bg-background rounded-2xl p-6 border border-border">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-base font-semibold font-heading">Institution Onboarding</h3>
                </div>
                <p className="text-sm text-muted-foreground mb-3">
                  Schools and universities can contact institutions@neurolearn.ai for bulk setup.
                </p>
              </div>
            </motion.div>
              ...
              <form onSubmit={handleSubmit} className="bg-background rounded-2xl p-6 border border-border space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 rounded-xl bg-card border border-border text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 transition-all"
                  >
                    <option value="">Select a topic</option>
                    <option value="general">General Inquiry</option>
                    <option value="partnership">Partnership Request</option>
                    <option value="institution">Institution Onboarding</option>
